...
%Gain better understanding of radiologist classification patterns of CXR images through eye tracking data. \\* %And how radiologists perceive other eye tracking classification pattern from other radiologists. \\*
...
%supports prediction of lung and heart diseases based on human classification patterns from eye tracking data, 
%and pupil dilations, 
